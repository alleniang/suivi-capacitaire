...
import { AjoutAppel } from './AjoutAppel';
...
export default function Appels() {
    ...
    const deleteAppel = (row) => {

        if (window.confirm("Voulez vous vraiment supprimer ?")) {
            axios.delete(`${serverUrl}/previsions/Appels/delete-Appels/${row._id}`)
    ...
    const formik = useFormik({
        initialValues: {
            ...
            appels: modalData && modalData.appels,
            previsions: modalData && modalData.previsions,

        },

        onSubmit: values => {
            axios.put(`${serverUrl}/previsions/Appels/update-Appels/${modalData._id}`, values)
                .then(res => {
        ...
        <div>
            ...
            >
                <Box sx={{ ...style, width: 400 }}>
                    ...
                    <h2 id="parent-modal-title" align="center">Ajouter Prévisions Appels</h2>
            ...
            >
                <Box sx={{ ...style, width: 400 }}>
                    ...
                    <h2 id="parent-modal-title" align="center">Modifier Prévisions Appels</h2>
                    <p id="parent-modal-description">
                            ...
                            <row>
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <TextField
                                        ...
                                        defaultValue={modalData && modalData.appels}
                                        size="small"
                                        onChange={formik.handleChange}
                                        required
                                    />
                ...
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell >Appels</StyledTableCell>
